...
export const CelticCrossMeanings: CelticCross = {
  1: {
    name: "1. The Present (Significator)",
    description:
  ...
  2: {
    name: "2. The Challenge (Crossing Card)",
    description:
  ...
  3: {
    name: "3. The Foundation (Root of the Matter)",
    description:
  ...
  5: {
    name: "5. The Goal or Destiny (Crowning Card)",
    description:
  ...
  7: {
    name: "7. The Querent’s Attitude or Internal Position",
    description:
